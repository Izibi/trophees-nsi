...
@section('content')
    @if(count($rows))
        ...
        <div class="mt-3 mb-3">
            <button class="btn btn-primary active-button" action="/projects/:id/edit" method="GET">Edit selected school</button>
            <button class="btn btn-primary active-button" action="/projects/:id/hide" method="POST">Hide selected school</button>
        </div>
